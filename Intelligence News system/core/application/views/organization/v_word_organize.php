                                                ...
                                                <tr>
                                                    <td style="width: 100%;" align="center">
                                                        ...
                                                        <div class="col-lg-3 blog-tag-data-inner center">
                                                            <?= (isset($result['o_mainimage']) and $result['o_mainimage']) ? '<div class="field" id="thumb"><label></label><img width="350" height="270" class="form-thumb" src="' . getImagePath($this->images_path . $result['o_organizationid'] . '/' . $result['o_mainimage']) . '" /></div>' :'<img src="assets/img/mockup/no-image.gif" alt="">'; ?>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    </td>
