                ...
                <form class="form-horizontal" enctype="multipart/form-data" method="POST">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-lg-2">
                                <label class="control-label right"> ชื่อประเภทข่าวกรอง* : </label>
                            </div>
                            <div class="col-lg-6">
                                <input class="form-control" name="nt_name" <?= (isset($result['nt_name']) and $result['nt_name']) ? 'value="'.$result['nt_name'].'"' : ''; ?> required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control" name="nt_description" <?= (isset($result['nt_description']) and $result['nt_description']) ? 'value="'.$result['nt_description'].'"' : ''; ?>>
                            </div>
                        </div>
