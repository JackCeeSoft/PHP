...
<!--                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-1">
                                                <input disabled type="text" id="p_firstname" class="form-control" name="p_title" value="<?php if(isset($result['p_title']) and $result['p_title']) echo $result['p_title']; ?>">
                                            </div>
                                            <div class="col-sm-1">
                                                <label>ชื่อ : *</label>
                                            </div>
                                            <div class="col-sm-3">
                                                <input disabled type="text" class="form-control" name="p_firstname" required value="<?php if(isset($result['p_firstname']) and $result['p_firstname']) echo $result['p_firstname']; ?>">
                                                <input type="hidden" class="form-control" name="p_firstname" required value="<?php if(isset($result['p_firstname']) and $result['p_firstname']) echo $result['p_firstname']; ?>">
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <input disabled type="text" class="form-control" name="p_lastname" required value="<?php if(isset($result['p_lastname']) and $result['p_lastname']) echo $result['p_lastname']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                        <div class="col-lg-6">
                                            <div class="input-append date" id="datetimepicker1" required >
                                                <input disabled data-format="yyyy-MM-dd" type="text" name="p_birthdate" value="<?php if(isset($result['p_birthdate']) and $result['p_birthdate']) echo $result['p_birthdate']; ?>">
                                                <span class="add-on">
                                            ...
                                            <div class="col-sm-1">
                                                <input disabled type="text" class="form-control" name="p_age" value="<?php if(isset($result['p_age']) and $result['p_age']) echo $result['p_age']; ?>">
                                            </div>
                                            <div class="col-sm-1">
                                                <label>ปี </label>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <select class="form-control" name="p_gender" disabled >
                                                    <option>ชาย</option>
                                                    <option>หญิง</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input disabled type="text" class="form-control" name="p_nickname"  value="<?php if(isset($result['p_nickname']) and $result['p_nickname']) echo $result['p_nickname']; ?>">
                                            </div>
                                            <div class="col-sm-1">
                                                <label>อาชีพ :  </label>
                                            </div>
                                            <div class="col-sm-3">
                                                <input disabled type="text" class="form-control" name="p_occupation"  value="<?php if(isset($result['p_occupation']) and $result['p_occupation']) echo $result['p_occupation']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                ?>
                                                <input disabled type="text" maxlength="13" name="p_idcard" value="<?php if(isset($p_idcard) and $p_idcard) echo $p_idcard; ?>" >
<!--                                                <input type="text" maxlength="1" class="span0" name="p_idcard_1" required value="<?php if(isset($p_idcard_1) and $p_idcard_1) echo $p_idcard_1; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input disabled type="text" class="form-control" name="p_position" value="<?php if(isset($result['p_position']) and $result['p_position']) echo $result['p_position']; ?>">
                                            </div>
                                            <div class="col-sm-2">
                                                <label>การศึกษา :  </label>
                                            </div>
                                            <div class="col-sm-2">
                                             <select class="form-control" name="p_education" disabled>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <textarea class="form-control" name="p_workaddress" disabled><?php if(isset($result['p_workaddress']) and $result['p_workaddress']) echo $result['p_workaddress']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-3">
                                                <input disabled type="text" class="form-control" name="p_nationality"  value="<?php if(isset($result['p_nationality']) and $result['p_nationality']) echo $result['p_nationality']; ?>">
                                            </div>
                                            <div class="col-sm-1">
                                                <label>เชื้อชาติ :  </label>
                                            </div>
                                            <div class="col-sm-3">
                                                <input disabled type="text" class="form-control" name="p_race"  value="<?php if(isset($result['p_race']) and $result['p_race']) echo $result['p_race']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <textarea disabled class="form-control" name="p_domicile"><?php if(isset($result['p_domicile']) and $result['p_domicile']) echo $result['p_domicile']; ?></textarea>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <textarea disabled class="form-control" name="p_address"  ><?php if(isset($result['p_address']) and $result['p_address']) echo $result['p_address']; ?></textarea>
                                            </div>
                                            <div class="col-sm-4" hidden="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input disabled type="text" class="form-control" name="p_spousefirstname" value="<?php if(isset($result['p_spousefirstname']) and $result['p_spousefirstname']) echo $result['p_spousefirstname']; ?>">
                                            </div>
                                            <div class="col-sm-1">
                                                <label>นามสกุล : </label>
                                            </div>
                                            <div class="col-sm-3">
                                                <input  disabled type="text" class="form-control" name="p_spouselastname" value="<?php if(isset($result['p_spouselastname']) and $result['p_spouselastname']) echo $result['p_spouselastname']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <textarea disabled  class="form-control" name="p_spouseaddress" value=""><?php if(isset($result['p_spouseaddress']) and $result['p_spouseaddress']) echo $result['p_spouseaddress']; ?></textarea>
                                            </div>
                                            <div class="col-sm-4" hidden="">
                                                <textarea  class="form-control" name="p_spouseaddress" value="<?php if(isset($result['p_spouseaddress']) and $result['p_spouseaddress']) echo $result['p_spouseaddress']; ?>"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-1">
                                                <input disabled type="text" class="form-control" name="p_child" value="<?php if(isset($result['p_child']) and $result['p_child']) echo $result['p_child']; ?>">
                                            </div>
                                            <div class="col-sm-1">
                                                <label>คน </label>
                                            </div>
                                            ...
                                            <div class="col-sm-1">
                                                <input disabled type="text" class="form-control" name="p_boy" value="<?php if(isset($result['p_boy']) and $result['p_boy']) echo $result['p_boy']; ?>">
                                            </div>
                                            <div class="col-sm-1">
                                                <label>คน </label>
                                            </div>
                                            ...
                                            <div class="col-sm-1">
                                                <input disabled type="text" class="form-control" name="p_daughter" value="<?php if(isset($result['p_daughter']) and $result['p_daughter']) echo $result['p_daughter']; ?>">
                                            </div>
                                            <div class="col-sm-1">
                                                <label>คน </label>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <textarea disabled class="form-control" placeholder="" name="p_childdetail"><?php if(isset($result['p_childdetail']) and $result['p_childdetail']) echo $result['p_childdetail'];?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input disabled type="text" class="form-control" name="p_fatherfirstname" value="<?php if(isset($result['p_fatherfirstname']) and $result['p_fatherfirstname']) echo $result['p_fatherfirstname']; ?>">
                                            </div>
                                            <div class="col-sm-1">
                                                <label>นามสกุล : </label>
                                            </div>
                                            <div class="col-sm-3">
                                                <input disabled type="text" class="form-control" name="p_fatherlastname" value="<?php if(isset($result['p_fatherlastname']) and $result['p_fatherlastname']) echo $result['p_fatherlastname']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input disabled type="text" class="form-control" name="p_fatheroccupation" value="<?php if(isset($result['p_fatheroccupation']) and $result['p_fatheroccupation']) echo $result['p_fatheroccupation']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <textarea disabled class="form-control" name="p_fatheraddress" value=""><?php if(isset($result['p_fatheraddress']) and $result['p_fatheraddress']) echo $result['p_fatheraddress']; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input disabled type="text" class="form-control" name="p_motherfirstname" value="<?php if(isset($result['p_motherfirstname']) and $result['p_motherfirstname']) echo $result['p_motherfirstname']; ?>">
                                            </div>
                                            <div class="col-sm-1">
                                                <label>นามสกุล : </label>
                                            </div>
                                            <div class="col-sm-3">
                                                <input disabled type="text" class="form-control" name="p_motherlastname" value="<?php if(isset($result['p_motherlastname']) and $result['p_motherlastname']) echo $result['p_motherlastname']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input disabled type="text" class="form-control" name="p_motheroccupation" value="<?php if(isset($result['p_motheroccupation']) and $result['p_motheroccupation']) echo $result['p_motheroccupation']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <textarea disabled class="form-control" name="p_motheraddress" value=""><?php if(isset($result['p_motheraddress']) and $result['p_motheraddress']) echo $result['p_motheraddress']; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-1">
                                                <input disabled type="text" class="form-control" name="p_sibling" value="<?php if(isset($result['p_sibling']) and $result['p_sibling']) echo $result['p_sibling']; ?>">
                                            </div>
                                            <div class="col-sm-1">
                                                <label>คน </label>
                                            </div>
                                            ...
                                            <div class="col-sm-1">
                                                <input disabled type="text" class="form-control" name="p_male" value="<?php if(isset($result['p_male']) and $result['p_male']) echo $result['p_male']; ?>">
                                            </div>
                                            <div class="col-sm-1">
                                                <label>คน </label>
                                            </div>
                                            ...
                                            <div class="col-sm-1">
                                                <input disabled type="text" class="form-control" name="p_female" value="<?php if(isset($result['p_female']) and $result['p_female']) echo $result['p_female']; ?>">
                                            </div>
                                            <div class="col-sm-1">
                                                <label>คน </label>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <textarea disabled class="form-control" placeholder="" name="p_siblingdesc" value=""><?php if(isset($result['p_siblingdesc']) and $result['p_siblingdesc']) echo $result['p_siblingdesc']; ?></textarea>
                                            </div>
                                        </div>

<!--                                        <div class="col-lg-10 col-lg-offset-2">
                                            <button type="submit" name="submit_tap" value="submit_tap1" class="btn btn-success">แก้ไข</button>
                                ...
                                <div class="col col-3">
                                       <?php 
                                        if(isset($image) && $image){
                                            foreach ($image as $key=>$values){
                                                echo ' <img src="upload/person_image_gallery/'.$image[$key]['p_personid'].'/'.$image[$key]['pi_path'].'" width="250" height="170">';
                                            } 
                                        }
                                       ?>
                                </div>
                                    ...
                                    <div class="tab-pane fade" id="profile2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                <textarea disabled class="ckeditor" name="editor1"><?php if(isset($result['p_behavior']) and $result['p_behavior']) echo $result['p_behavior']; ?></textarea>
                                            </div>
