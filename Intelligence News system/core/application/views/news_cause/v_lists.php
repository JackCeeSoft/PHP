<div id="page-wrapper" class="bg-fff">
    ...
    <div class="container">
        <div class="col-lg-12 mb-20 text-right">
            <a href="<?= site_url('news_cause/insert'); ?>" class="btn btn-primary">เพิ่มลักษณะการก่อเหตุ</a>
        </div>
                        ...
                        <?php if(isset($lists) and $lists) { ?>
                            <?php foreach ($lists as $k_lists => $v_lists) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <center>
                                            <span><a href="<?= site_url('news_cause/update/' . $v_lists['nc_newscauseid']); ?>"><img src="assets/img/icon/edit.png" width="16" height="16" alt="" title="แก้ไข"></a></span>
                                            <span><a class="del-paragraph" href="<?= site_url('news_cause/delete/' . $v_lists['nc_newscauseid']); ?>" class="del"><img src="assets/img/icon/delete.png" width="16" height="16" alt="" title="ลบ"></a></span>
                                        </center>
                                    </td>
                                </tr>
                            <?php } ?>
