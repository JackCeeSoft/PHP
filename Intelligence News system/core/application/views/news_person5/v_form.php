                ...
                <form class="form-horizontal" enctype="multipart/form-data" method="POST">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-lg-2">
                                <label class="control-label right"> ลำดับบุคคล* : </label>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <div class="col-lg-2">
                                <label class="control-label right"> ชื่อบุคคล* : </label>
                            </div>
                            <div class="col-lg-6">
                                <input required class="form-control" name="np_person" <?= (isset($result['np_person']) and $result['np_person']) ? 'value="'.$result['np_person'].'"' : ''; ?>>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                                ...
                                <a href="<?= site_url('news_person5/lists'); ?>" class="btn btn-default">ยกเลิก</a>
                            </div>
                        </div>
                    </fieldset>
                </form>
