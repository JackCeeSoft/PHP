                            ...
                            <fieldset>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group type">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control required" name="n_subject" required <?= (isset($result['n_subject']) and $result['n_subject']) ? 'value="'.$result['n_subject'].'"' : ''; ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group type type-2 type-3"><!-- ชื่อผู้เขียนข่าว -->
                                        <div class="col-lg-3">
                        ...
                        <form action="" id="paragraph" class="form-horizontal section" enctype="multipart/form-data" method="post">
                            ...
                            <fieldset>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-3">
                                            <label class="control-label right"> รูปภาพ : </label>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-lg-5">
