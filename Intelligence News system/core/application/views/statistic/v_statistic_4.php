                ...
                <table class="tg">
                    <tr>
                        ...
                        <?php
                            ...
                            $sum_x4 = 0;
                        ?>
                        <?php foreach($news_harry5 as $k_ne5 => $v_ne5) { ?>
                                    ...
                                    foreach($all_data_count as $k_adc => $v_adc) { 
                                        if($v_adc['np_newsprovinceid'] == 76){
                                            if($v_adc['nh_newsharryid'] == $v_ne5['nh_newsharryid']) { 
                                                ...
                                                $check_print = 1;
                                                echo '<td class="tg-031e" style="text-align:right">' . $v_adc['nh_newsharry_total'] . '</td>';
                                            }
                                        }
                                    }
                                    if($check_print == 0){
            ...
            <?php 
                ...
                if( isset( $core_type ) && $core_type == 2 ) {
                    foreach($news_harry5 as $k_ne5 => $v_ne5) {
                                ...
                                foreach($all_data_count as $k_adc => $v_adc) { 
                                    if($v_adc['np_newsprovinceid'] == $key_province) {
                                        if($v_adc['nh_newsharryid'] == $v_ne5['nh_newsharryid']) { 
                                            ...
                                            $check_print = 1;
                                            $grahpData .= $v_adc['nh_newsharry_total'];
                                            $hasData += $v_adc['nh_newsharry_total'];
                                        }
                                    }
                                }
                                if($check_print == 0) {
                        ...
                        $grahpData .= ']';
                        $arrGrahp[$k_ne5]['name'] = $v_ne5['nh_name'];
